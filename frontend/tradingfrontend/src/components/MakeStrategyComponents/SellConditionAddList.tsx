...
export default function SellConditionAddList(props: any) {
  function IndividualIndicators(props: any) {
    ...
    const handleCompareMode= (event: SelectChangeEvent) => {
    ...
    const handleCompleteEdit = () => {
      dispatch({
        type: StrategyTypes.UPDATE_SELL_INDICATOR,
        payload: {
    ...
    const handleDelete = () => {
      dispatch({
        type: StrategyTypes.DELETE_SELL_INDICATOR,
        payload: {
          strategy_id: props.strategy_id,
          sell_and_indicator: {
            id: props.indicator.id,
